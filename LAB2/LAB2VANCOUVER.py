...
plt.legend(loc='best')
plt.title(' Mean & Standard Deviation for Vancouver window size = 1 week')
plt.xlabel('Hours')
plt.ylabel('Number of Bookings')
plt.show()
...
plt.axhline(y=1.96/np.sqrt(len(df['Bookings'])), linestyle='--', color='gray')
plt.title('Autocorrelation Function (ACF) Vancouver ')
plt.xlabel('Lags')
plt.ylabel('ACF')
...
plt.axhline(y=-1.96/np.sqrt(len(df['Bookings'])), linestyle='--', color='gray')
plt.axhline(y=1.96/np.sqrt(len(df['Bookings'])), linestyle='--', color='gray')
plt.title('Partial Autocorrelation Function (PACF)  Vancouver')
plt.xlabel('Lags')
plt.ylabel('PACF')
plt.tight_layout()
plt.show()
...
plt.title(' prediction over all selected data set for Vancouver with AR model p equal 2')
...
plt.colorbar()
plt.title('MAE Heatmap Vancouver')
plt.xlabel('q values')
plt.ylabel('p values')
...
plt.colorbar()
plt.title('MSE Heatmap Vancouver')
plt.xlabel('q values')
plt.ylabel('p values')
plt.xticks(np.arange(5), np.arange(5))
plt.yticks(np.arange(5), np.arange(1, 6))
...
plt.colorbar()
plt.title('R2 Heatmap Vancouver')
plt.xlabel('q values')
plt.ylabel('p values')
plt.xticks(np.arange(5), np.arange(5))
plt.yticks(np.arange(5), np.arange(1, 6))
...
plt.colorbar()
plt.title('MAPE Heatmap Vancouver')
plt.xlabel('q values')
plt.ylabel('p values')
plt.xticks(np.arange(5), np.arange(5))
plt.yticks(np.arange(5), np.arange(1, 6))
...
plt.title('Mean Absolute Error (MAE) Over Expanding Window MLE method Vancouver')
...
plt.title('Mean Absolute Percentage Error (MAPE) Over Expanding Window MLE method Vancouver')
plt.xlabel('End of Training Set Index')
plt.ylabel('MAPE')
plt.legend()
...
plt.title('R-squared (R2) Over Expanding Window MLE method Vancouver')
plt.xlabel('End of Training Set Index')
plt.ylabel('R2')
plt.legend()
...
plt.title('Actual vs Predicted Values Expanding Window MLE method Vancouver')
plt.xlabel('Hour')
plt.ylabel('Bookings')
plt.legend()
...
plt.subplot(4, 1, 1)
plt.plot(end_train_values, mae_values, marker='o', linestyle='-', color='blue', label='MAE')
plt.title('Mean Absolute Error (MAE) Over Expanding Window Vancouver')
plt.xlabel('End of Training Set Index')
plt.ylabel('MAE')
plt.legend()
...
plt.subplot(4, 1, 2)
plt.plot(end_train_values, mape_values, marker='o', linestyle='-', color='orange', label='MAPE')
plt.title('Mean Absolute Percentage Error (MAPE) Over Expanding Window Vancouver')
plt.xlabel('End of Training Set Index')
plt.ylabel('MAPE')
plt.legend()
...
plt.subplot(4, 1, 3)
plt.plot(end_train_values, r2_values, marker='o', linestyle='-', color='green', label='R2')
plt.title('R-squared (R2) Over Expanding Window Vancouver')
plt.xlabel('End of Training Set Index')
plt.ylabel('R2')
plt.legend()
...
plt.title('Actual vs Predicted Values Expanding Window Vancouver')
plt.xlabel('Hour')
plt.ylabel('Bookings')
plt.legend()
...
plt.title('Mean Absolute Error (MAE) Over Sliding Window Vancouver')
plt.xlabel('End of Training Set Index')
plt.ylabel('MAE')
...
plt.title('Mean Absolute Percentage Error (MAPE) Over Sliding Window Vancouver')
plt.xlabel('End of Training Set Index')
plt.ylabel('MAPE')
...
plt.title('R-squared (R2) Over Sliding Window Vancouver')
plt.xlabel('End of Training Set Index')
plt.ylabel('R2')
...
print(f"MAE over entire period Vancouver: {mae}")
print(f"MAPE over entire period Vancouver: {mape}")
print(f"R^2 over entire period Vancouver: {r2}")


# In[23]:


#####error metrics over total period with method='innovations_mle'
import pandas as pd
import numpy as np
from statsmodels.tsa.arima.model import ARIMA
import matplotlib.pyplot as plt
