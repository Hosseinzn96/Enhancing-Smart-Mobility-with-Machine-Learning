...
plt.legend(loc='best')
plt.title(' Mean & Standard Deviation for Roma enjoy window size = 1 week')
plt.xlabel('Hours')
plt.ylabel('Number of Bookings')
plt.show()
...
plt.axhline(y=1.96/np.sqrt(len(df['Bookings'])), linestyle='--', color='gray')
plt.title('Autocorrelation Function (ACF) Roma ')
plt.xlabel('Lags')
plt.ylabel('ACF')
...
plt.axhline(y=-1.96/np.sqrt(len(df['Bookings'])), linestyle='--', color='gray')
plt.axhline(y=1.96/np.sqrt(len(df['Bookings'])), linestyle='--', color='gray')
plt.title('Partial Autocorrelation Function (PACF)  Roma')
plt.xlabel('Lags')
plt.ylabel('PACF')
plt.tight_layout()
plt.show()
...
plt.title(' prediction over all selected data set for Roma with AR model p equal 3')
...
plt.title('Mean Absolute Error (MAE) Over Expanding Window MLE method')
...
plt.title('Mean Absolute Percentage Error (MAPE) Over Expanding Window MLE method')
plt.xlabel('End of Training Set Index')
plt.ylabel('MAPE')
plt.legend()
...
plt.title('R-squared (R2) Over Expanding Window MLE method')
plt.xlabel('End of Training Set Index')
plt.ylabel('R2')
plt.legend()
...
plt.title('Actual vs Predicted Values Expanding Window MLE method Roma')
plt.xlabel('Hour')
plt.ylabel('Bookings')
plt.legend()
...
plt.subplot(4, 1, 1)
plt.plot(end_train_values, mae_values, marker='o', linestyle='-', color='blue', label='MAE')
plt.title('Mean Absolute Error (MAE) Over Expanding Window Roma')
plt.xlabel('End of Training Set Index')
plt.ylabel('MAE')
plt.legend()
...
plt.subplot(4, 1, 2)
plt.plot(end_train_values, mape_values, marker='o', linestyle='-', color='orange', label='MAPE')
plt.title('Mean Absolute Percentage Error (MAPE) Over Expanding Window Roma')
plt.xlabel('End of Training Set Index')
plt.ylabel('MAPE')
plt.legend()
...
plt.subplot(4, 1, 3)
plt.plot(end_train_values, r2_values, marker='o', linestyle='-', color='green', label='R2')
plt.title('R-squared (R2) Over Expanding Window Roma')
plt.xlabel('End of Training Set Index')
plt.ylabel('R2')
plt.legend()
...
plt.title('Actual vs Predicted Values Expanding Window Roma')
plt.xlabel('Hour')
plt.ylabel('Bookings')
plt.legend()
...
plt.title('Mean Absolute Error (MAE) Over Sliding Window Roma')
plt.xlabel('End of Training Set Index')
plt.ylabel('MAE')
...
plt.title('Mean Absolute Percentage Error (MAPE) Over Sliding Window Roma')
plt.xlabel('End of Training Set Index')
plt.ylabel('MAPE')
...
plt.title('R-squared (R2) Over Sliding Window Roma')
plt.xlabel('End of Training Set Index')
plt.ylabel('R2')
...
print(f"MAE over entire period Roma: {mae}")
print(f"MAPE over entire period Roma: {mape}")
print(f"R^2 over entire period Roma: {r2}")
